 ...
 *
 */
#ifndef _SPACE_MYLINGUA_JUST_SKILL_H_
#define _SPACE_MYLINGUA_JUST_SKILL_H_
...
#define SPACE_MYLINGUA_JUST_SKILL "mylingua_just_skill"

namespace similarity {

template <typename dist_t, typename dist_uint_t>
class SpaceMyLinguaJustSkill : public SpaceBitVector<dist_t,dist_uint_t> {
 public:
  explicit SpaceMyLinguaJustSkill() {}
  virtual ~SpaceMyLinguaJustSkill() {}

  virtual std::string StrDesc() const { return "Mylingua skill distance"; }
 ...
 protected:
  ...
  DISABLE_COPY_AND_ASSIGN(SpaceMyLinguaJustSkill);
};
