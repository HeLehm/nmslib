 ...
 *
 */
#ifndef _SPACE_MYLINGUA_DISTANCE_CHAR_FREQ_H_
#define _SPACE_MYLINGUA_DISTANCE_CHAR_FREQ_H_
...
#define SPACE_MYLINGUA_DISTANCE_CHAR_FREQ "mylingua_distance_char_freq"

namespace similarity {

template <typename dist_t, typename dist_uint_t>
class SpaceMyLinguaDistanceCharFreq : public SpaceBitVector<dist_t,dist_uint_t> {
 public:
  explicit SpaceMyLinguaDistanceCharFreq() {}
  virtual ~SpaceMyLinguaDistanceCharFreq() {}

  virtual std::string StrDesc() const { return "Mylingua char freq distance"; }
 ...
 protected:
  virtual dist_t HiddenDistance(const Object* obj1, const Object* obj2) const {
    ...
    std::cout << "[NMSLIB DEBUG] userCharFreqMedian = " << userCharFreqMedian << "\n";
    std::cout.flush();
    ...
    // get char score 
    dist_t char_dist = BitFreqOnly<dist_t,dist_uint_t>(x_int, y_int, userCharFreqMedian,mylingua_constants::MYLINGUA_CHAR_VOCAB_LENGTH);
    
    return char_dist;
  }

  DISABLE_COPY_AND_ASSIGN(SpaceMyLinguaDistanceCharFreq);
};
